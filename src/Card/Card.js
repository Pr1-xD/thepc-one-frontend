        ...
        <div>   
            <div className="card_contentBox card card_box mb-3">
                ...
                <div className="card_body card-body">
                    <h5 className="card_title card-title">Card title</h5>
                    ...
                    <p className="card_bodyFooter card-text"><b>DATE: <span className="card_footerColor">4/10/2020</span></b>     &emsp;  &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; <b>TIME: <span className="card_footerColor">2-6 PM</span></b></p>          <button type="button" class="btn btn-primary card_button">Register</button>
                </div>
            </div>
        </div>
    )
